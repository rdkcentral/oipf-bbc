...
const supportedOipfObjects = ['application/oipfApplicationManager', 'application/oipfConfiguration', 'video/broadcast'];
...
const oipfObjectFactory = {
    ...
    isObjectSupported: function(mimeType) {
        return supportedOipfObjects.includes(mimeType);
    }
};
