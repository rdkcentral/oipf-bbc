...
export function getCountry() {
    return send({
        ...
        console.error(e);
        throw new OipfError(311, 'An unexpected error occured', e.printable);
    });
}
...
export function getPreferredAudioLanguages() {
    return send({
        ...
        console.error(e);
        throw new OipfError(303, 'An unexpected error occured', e.printable);
    });
}
...
export function getClosedCaptionsSettings() {
    return send({
        ...
        console.error(e);
        throw new OipfError(304, 'An unexpected error occured', e.printable);
    });
}
...
export function getAudioDescription() {
    return send({
        ...
        console.error(e);
        throw new OipfError(318, 'An unexpected error occured', e.printable);
    });
}
