...
export function getDisplaySize() {
    return send({
        ...
        throw new OipfError(406, 'An unexpected error occured', e.printable);
    });
}
...
export function getDisplayVideoResolutions() {
    return send({
        ...
        throw new OipfError(407, 'An unexpected error occured', e.printable);
    });
}
...
export function getDisplayColorimetry() {
    return send({
        ...
        throw new OipfError(408, 'An unexpected error occured', e.printable);
    });
}
...
export function getDisplayInfo() {
    return send({
        ...
        .then(edid => ({ edid }))
        .catch(e => {
            throw new OipfError(401, 'An unexpected error occured', e.printable);
        });
}
