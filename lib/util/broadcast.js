...
export function getChannelByNumber(channelNumber) {
    return getChannels()
        ...
        .catch(e => {
            console.error(e);
            throw new OipfError(110, 'An unexpected error occured', e.printable);
        });
}
...
export function getChannelByName(name) {
    return getChannels()
        ...
        .catch(e => {
            console.error(e);
            throw new OipfError(107, 'An unexpected error occured', e.printable);
        });
}
...
export function getChannelById(id) {
    return getChannels([id])
        ...
        .catch(e => {
            console.error(e);
            throw new OipfError(108, 'An unexpected error occured', e.printable);
        });
}
...
export function tuneToChannelByNumber(channelNumber) {
    return getChannels()
        ...
        .catch(e => {
            console.error(e);
            throw new OipfError(123, 'An unexpected error occured', e.printable);
        });
}
...
export function tuneToChannelByName(name) {
    return getChannels()
        ...
        .catch(e => {
            console.error(e);
            throw new OipfError(132, 'An unexpected error occured', e.printable);
        });
}
...
export function tuneToChannelById(channelId) {
    return getChannelById(channelId)
        ...
        .catch(e => {
            console.error(e);
            throw new OipfError(124, 'An unexpected error occured', e.printable);
        });
}
